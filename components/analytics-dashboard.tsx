...
export function AnalyticsDashboard() {
      ...
      <div className="w-full">
        <Card className="border-dashed">
          <CardHeader className="text-center">
            ...
            <CardDescription>최신 사용자 통계를 가져오고 있습니다</CardDescription>
          </CardHeader>
        </Card>
      </div>
    )
  ...
  const conversionRate = calculateConversionRate(analytics.analysisCompleted, analytics.interviewStarted)
    ...
    <div className="w-full space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <Card className="relative overflow-hidden">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-green-600">{analytics.interviewStarted.toLocaleString()}</div>
            <p className="text-xs text-muted-foreground">
              면접을 시작한 사용자
            </p>
        ...
        <Card className="relative overflow-hidden">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-purple-600">{analytics.analysisCompleted.toLocaleString()}</div>
            <p className="text-xs text-muted-foreground">
              답변 분석을 받은 사용자
            </p>
      ...
      <div className="text-center">
        <p className="text-xs text-muted-foreground">
          ...
          <span className="text-primary">Google Analytics</span> 기반
        </p>
      </div>
    </div>
  )
